...
public class Invoice implements Serializable {
     ...
     * 增值发票是否可抛  0 可抛  1 不可抛
     */
    public final static int INV_THROW_ALLOW = 0;
    public final static int INV_THROW_REFUSE = 1;
    /**
     * 发票类型 电子  增值  普通
     */
    public final static int INVOICE_TYPE_D = 1;
    public final static int INVOICE_TYPE_Z = 2;
    public final static int INVOICE_TYPE_P = 3;
    ...
    private Integer taxNoType;//1 15 20位，2 18位，3 无
