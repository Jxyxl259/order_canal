...
/**
 * @description: 订单全量库增量订阅canalConsumer
 * @author: jiangxy9
 * @create: 2019-08-26 20:49
 */
public class OrderCenterDBCanalConsumer implements Runnable {

    private static Logger log = LoggerFactory.getLogger(OrderCenterDBCanalConsumer.class);
